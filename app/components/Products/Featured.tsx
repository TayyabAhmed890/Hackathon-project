...
const Featured = () => {
  return (
   ...
   <section className='mt-8 h-auto w-auto flex flex-col items-center justify-center'>
    ...
    <h1 className={`${lato.className} font-bold text-[18px] group-hover:text-white`}>Cantilever chair</h1>
    ...
    <h1 className={`${Josefin.className} font-semibold text-[14px] group-hover:text-white text-[#151875]`}>Code - Y523201</h1>
    <h1 className={`mb-3 ${lato.className} font-semibold text-[14px] group-hover:text-white text-[#151875]`}>$42.00</h1>
    </div>
    <div className='hover:bg-[#2F1AC4] group hover:text-white h-[361px] w-[270px] flex justify-between items-center flex-col relative'><div className='h-[236px] w-[270px] flex items-center justify-center bg-gray-50'>
    <div className='  hidden absolute top-2 left-2 w-auto group-hover:block'>
          <div className='flex gap-3 '>
          <div className='rounded-full bg-[#EEEFFB] h-[30px] w-[30px] flex items-center justify-center'><FiShoppingCart height={14} width={14} className='text-[#2F1AC4]'/></div>
          <div className='rounded-full h-[30px] w-[30px] flex items-center justify-center'><FaRegHeart height={17} width={17} className='text-[#1DB4E7]'/></div>
