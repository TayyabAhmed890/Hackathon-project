...
const ProductDetail = () => {
  ...
  // Use useParams to fetch the dynamic route parameter
  const params = useParams();
  const { productId } = params; // Fetch product_id from URL
  ...
  return (
    <div >
      <section className="text-gray-600 body-font overflow-hidden ">
          <Link href="/">
        <div className="bg-indigo-500 text-white hover:bg-indigo-600 w-11 flex items-center justify-center mx-8  rounded-lg py-2">
